...
public class DrawingSurface extends PApplet {
	...
	public static final String ratingsFile = "small" + FileIO.fileSep + "ratings.csv";
	public static final String moviesFile = "small" + FileIO.fileSep + "movies.csv";
	public static final String linksFile = "small" + FileIO.fileSep + "links.csv";
	public static final String tagsFile = "small" + FileIO.fileSep + "tags.csv";
	...
	public void draw() {
		...
		if (predictorLoaded) {
			...
			recommendedMovie.draw(this, DRAWING_WIDTH/2-DRAWING_WIDTH/4, DRAWING_HEIGHT/2.5f + 30, DRAWING_WIDTH/2, DRAWING_HEIGHT/2 + 30);
